...
- (void)requestReceivedResponseHeaders:(NSMutableDictionary *)newResponseHeaders
{
    ...
    @try {
        if(delegate!=nil)
        if (delegate && [delegate respondsToSelector:self.didReceiveResponseHeadersSelector]) {
            [delegate performSelector:self.didReceiveResponseHeadersSelector withObject:self withObject:newResponseHeaders];
        }
